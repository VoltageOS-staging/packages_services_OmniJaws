...
package org.omnirom.omnijaws.ui.compose.scaffold
...
private fun OmniTopAppBar(
    ...
    val colors = OmniTopAppBarColors(
        containerColor = MaterialTheme.colorScheme.surfaceContainer,
            ...
            content = {
                Box(Modifier.layoutId("navigationIcon")) {
                    CompositionLocalProvider(
                        ...
                        OmniBackButton(onClick = onBackClick)
                    }
                }
...
@Stable
private class OmniTopAppBarColors(
